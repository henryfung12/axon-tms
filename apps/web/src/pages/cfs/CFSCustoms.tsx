...
const MOCK_ENTRIES: CustomsEntry[] = [
  { id: 'ce1', orderNumber: 'JFK-IMP-0901', mawb: '176-82445521', hawb: 'GE-H-20260414-001', module: 'CFS_IMPORT', entryNumber: 'ENT-2026-04140001', entryType: '01 â€” Consumption', filerCode: 'AGS', airline: 'Korean Air', flightNumber: 'KE 082', airport: 'JFK', shipper: 'Samsung Electronics Co.', shipperCountry: 'KR', consignee: 'Tech Distributors LLC', commodity: 'Electronic Components', htsCode: '8542.31.0000', pieces: 12, weight: '2,400 kg', declaredValue: 48000, customsStatus: 'RELEASED', holdType: '', holdDetails: '', isfStatus: 'ACCEPTED', isfFiledDate: '2026-04-12', isfBondType: 'Continuous Bond', examType: '', examDate: '', examLocation: '', filedDate: '2026-04-13', releasedDate: '2026-04-14', liquidatedDate: '', broker: 'AGS Broker c/o Gemini', assignedTo: 'Chen Xia', documents: [{ name: 'Commercial_Invoice_Samsung.pdf', type: 'Commercial Invoice', status: 'APPROVED' }, { name: 'Packing_List_KE082.pdf', type: 'Packing List', status: 'APPROVED' }, { name: 'ISF_176-82445521.pdf', type: 'ISF Filing', status: 'ACCEPTED' }], notes: '' },
  { id: 'ce2', orderNumber: 'JFK-IMP-0902', mawb: '180-99321100', hawb: 'GE-H-20260414-002', module: 'CFS_IMPORT', entryNumber: 'ENT-2026-04140002', entryType: '01 â€” Consumption', filerCode: 'AGS', airline: 'Cathay Pacific', flightNumber: 'CX 840', airport: 'JFK', shipper: 'Global Textile Co.', shipperCountry: 'HK', consignee: 'NY Fashion Import Inc.', commodity: 'Textile / Garments', htsCode: '6204.62.4020', pieces: 48, weight: '6,200 kg', declaredValue: 82000, customsStatus: 'RELEASED', holdType: '', holdDetails: '', isfStatus: 'ACCEPTED', isfFiledDate: '2026-04-12', isfBondType: 'Single Transaction', examType: '', examDate: '', examLocation: '', filedDate: '2026-04-13', releasedDate: '2026-04-14', liquidatedDate: '', broker: 'AGS Broker c/o Gemini', assignedTo: 'Chen Xia', documents: [{ name: 'CI_GlobalTextile.pdf', type: 'Commercial Invoice', status: 'APPROVED' }, { name: 'ISF_180-99321100.pdf', type: 'ISF Filing', status: 'ACCEPTED' }], notes: 'Deconsolidation â€” 6 sub-lots for different consignees' },
  { id: 'ce3', orderNumber: 'JFK-IMP-0892', mawb: '131-55782100', hawb: 'GE-H-20260413-008', module: 'CFS_IMPORT', entryNumber: 'ENT-2026-04130008', entryType: '01 â€” Consumption', filerCode: 'AGS', airline: 'Emirates', flightNumber: 'EK 202', airport: 'JFK', shipper: 'Arabian Fresh Foods', shipperCountry: 'AE', consignee: 'Gourmet Imports USA', commodity: 'Perishable â€” Fresh Dates', htsCode: '0804.10.4000', pieces: 24, weight: '3,800 kg', declaredValue: 28500, customsStatus: 'HOLD', holdType: 'FDA', holdDetails: 'FDA Prior Notice required for food imports. Shipment flagged for inspection â€” perishable goods must pass FDA sampling before release. Prior Notice confirmation #PN-2026-0413-88201.', isfStatus: 'ACCEPTED', isfFiledDate: '2026-04-11', isfBondType: 'Continuous Bond', examType: '', examDate: '', examLocation: '', filedDate: '2026-04-13', releasedDate: '', liquidatedDate: '', broker: 'AGS Broker c/o Gemini', assignedTo: 'Maria Santos', documents: [{ name: 'CI_ArabianFresh.pdf', type: 'Commercial Invoice', status: 'APPROVED' }, { name: 'FDA_Prior_Notice.pdf', type: 'FDA Prior Notice', status: 'PENDING' }, { name: 'Phytosanitary_Cert.pdf', type: 'Phyto Certificate', status: 'APPROVED' }], notes: 'URGENT â€” perishable goods in cold storage. FDA inspection needed ASAP.' },
  { id: 'ce4', orderNumber: 'MIA-IMP-0321', mawb: '235-11887400', hawb: 'GE-H-20260414-004', module: 'CFS_IMPORT', entryNumber: 'ENT-2026-04140004', entryType: '01 â€” Consumption', filerCode: 'AGS', airline: 'LATAM', flightNumber: 'LA 500', airport: 'MIA', shipper: 'FarmacÃªutica Brasil', shipperCountry: 'BR', consignee: 'US Pharma Distribution', commodity: 'Pharmaceutical â€” Cold Chain', htsCode: '3004.90.9290', pieces: 6, weight: '420 kg', declaredValue: 125000, customsStatus: 'HOLD', holdType: 'FDA', holdDetails: 'FDA Drug Import requires prior listing of drug establishment. NDC number verification pending. Holding at temperature-controlled facility.', isfStatus: 'ACCEPTED', isfFiledDate: '2026-04-12', isfBondType: 'Continuous Bond', examType: '', examDate: '', examLocation: '', filedDate: '2026-04-14', releasedDate: '', liquidatedDate: '', broker: 'AGS Broker c/o Gemini', assignedTo: 'Maria Santos', documents: [{ name: 'CI_FarmBrasil.pdf', type: 'Commercial Invoice', status: 'APPROVED' }, { name: 'FDA_Drug_Listing.pdf', type: 'FDA Drug Listing', status: 'PENDING' }, { name: 'Cold_Chain_Certificate.pdf', type: 'Cold Chain Cert', status: 'APPROVED' }], notes: 'High value pharma â€” maintain 2-8Â°C until released' },
  { id: 'ce5', orderNumber: 'ORD-IMP-0450', mawb: '618-77200100', hawb: 'GE-H-20260414-011', module: 'CFS_IMPORT', entryNumber: 'ENT-2026-04140005', entryType: '01 â€” Consumption', filerCode: 'AGS', airline: 'ANA', flightNumber: 'NH 112', airport: 'ORD', shipper: 'Tokyo Chemical Corp', shipperCountry: 'JP', consignee: 'Midwest Chemical Dist.', commodity: 'DG â€” Chemical Reagents', htsCode: '2909.19.1400', pieces: 8, weight: '640 kg', declaredValue: 18200, customsStatus: 'HOLD', holdType: 'EPA', holdDetails: 'EPA TSCA (Toxic Substances Control Act) certification required. TSCA positive declaration form needed before release.', isfStatus: 'ACCEPTED', isfFiledDate: '2026-04-12', isfBondType: 'Continuous Bond', examType: '', examDate: '', examLocation: '', filedDate: '2026-04-14', releasedDate: '', liquidatedDate: '', broker: 'AGS Broker c/o Gemini', assignedTo: 'Chen Xia', documents: [{ name: 'CI_TokyoChem.pdf', type: 'Commercial Invoice', status: 'APPROVED' }, { name: 'MSDS_Reagents.pdf', type: 'MSDS / SDS', status: 'APPROVED' }, { name: 'TSCA_Declaration.pdf', type: 'TSCA Declaration', status: 'PENDING' }], notes: 'DG Class 6 â€” requires TSCA positive declaration' },
  { id: 'ce6', orderNumber: 'DFW-IMP-0210', mawb: '297-88100345', hawb: 'GE-H-20260414-006', module: 'CFS_IMPORT', entryNumber: '', entryType: '', filerCode: '', airline: 'Lufthansa', flightNumber: 'LH 438', airport: 'DFW', shipper: 'Bosch GmbH', shipperCountry: 'DE', consignee: 'Texas Industrial Supply', commodity: 'Industrial Machinery Parts', htsCode: '8479.89.9599', pieces: 16, weight: '3,200 kg', declaredValue: 44000, customsStatus: 'NOT_FILED', holdType: '', holdDetails: '', isfStatus: 'NOT_FILED', isfFiledDate: '', isfBondType: '', examType: '', examDate: '', examLocation: '', filedDate: '', releasedDate: '', liquidatedDate: '', broker: 'AGS Broker c/o Gemini', assignedTo: 'Chen Xia', documents: [], notes: 'Flight arriving 1:00 PM â€” ISF and entry must be filed upon arrival' },
  { id: 'ce7', orderNumber: 'ATL-IMP-0156', mawb: '057-22441890', hawb: 'GE-H-20260413-007', module: 'CFS_IMPORT', entryNumber: 'ENT-2026-04130007', entryType: '01 â€” Consumption', filerCode: 'AGS', airline: 'Delta Cargo', flightNumber: 'DL 200', airport: 'ATL', shipper: 'ChÃ¢teau Wines SARL', shipperCountry: 'FR', consignee: 'Southeast Wine Imports', commodity: 'Wine â€” Temperature Sensitive', htsCode: '2204.21.5060', pieces: 40, weight: '4,600 kg', declaredValue: 36000, customsStatus: 'HOLD', holdType: 'MULTI', holdDetails: 'TTB (Alcohol and Tobacco) â€” federal basic importers permit required. USDA â€” wood packing material inspection (ISPM-15). Both agencies must release before cargo can move.', isfStatus: 'ACCEPTED', isfFiledDate: '2026-04-11', isfBondType: 'Continuous Bond', examType: '', examDate: '', examLocation: '', filedDate: '2026-04-13', releasedDate: '', liquidatedDate: '', broker: 'AGS Broker c/o Gemini', assignedTo: 'Maria Santos', documents: [{ name: 'CI_ChateauWines.pdf', type: 'Commercial Invoice', status: 'APPROVED' }, { name: 'TTB_Import_Permit.pdf', type: 'TTB Permit', status: 'PENDING' }, { name: 'ISPM15_WoodPacking.pdf', type: 'ISPM-15 Cert', status: 'PENDING' }], notes: 'TTB permit pending + USDA ISPM-15 wood packing check' },
  { id: 'ce8', orderNumber: 'JFK-IMP-0905', mawb: '131-99100300', hawb: 'GE-H-20260414-014', module: 'CFS_IMPORT', entryNumber: 'ENT-2026-04140008', entryType: '01 â€” Consumption', filerCode: 'AGS', airline: 'Emirates', flightNumber: 'EK 202', airport: 'JFK', shipper: 'Bangladesh RMG Export', shipperCountry: 'BD', consignee: 'H&M Distribution', commodity: 'Ready-Made Garments', htsCode: '6109.10.0012', pieces: 60, weight: '7,800 kg', declaredValue: 52000, customsStatus: 'EXAM', holdType: 'CBP', holdDetails: 'CBP selected for VACIS (X-ray) examination. Shipment must be presented at CBP exam site â€” JFK CES facility. Exam appointment scheduled.', isfStatus: 'ACCEPTED', isfFiledDate: '2026-04-12', isfBondType: 'Continuous Bond', examType: 'VACIS', examDate: '2026-04-15T09:00:00Z', examLocation: 'JFK CES â€” Bldg 77', filedDate: '2026-04-14', releasedDate: '', liquidatedDate: '', broker: 'AGS Broker c/o Gemini', assignedTo: 'Chen Xia', documents: [{ name: 'CI_Bangladesh_RMG.pdf', type: 'Commercial Invoice', status: 'APPROVED' }, { name: 'CBP_Exam_Notice.pdf', type: 'CBP Exam Notice', status: 'RECEIVED' }], notes: 'VACIS exam scheduled 4/15 9:00 AM at JFK CES Bldg 77' },
];
...
export function CFSCustoms() {
  ...
  return (
    <div>
      ...
      {/* â”€â”€ All Entries â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
            ...
            <table className="w-full text-xs"><thead><tr className="bg-gray-50 border-b border-gray-200">
              ...
              {filtered.map(e => (
                <tr key={e.id} className={`border-b border-gray-100 hover:bg-gray-50 cursor-pointer ${e.customsStatus === 'HOLD' ? 'bg-red-50 border-l-4 border-l-red-400' : e.customsStatus === 'EXAM' ? 'bg-orange-50 border-l-4 border-l-orange-400' : e.customsStatus === 'NOT_FILED' ? 'bg-yellow-50' : ''}`} onClick={() => setSelectedEntry(e)}>
                  <td className="px-3 py-2.5 font-mono text-blue-600 font-medium">{e.entryNumber || 'â€”'}</td>
                  ...
                  <td className="px-3 py-2.5">{e.holdType ? <span className={`px-1.5 py-0.5 rounded text-xs font-bold ${HOLD_BADGE[e.holdType].color}`}>{HOLD_BADGE[e.holdType].icon} {HOLD_BADGE[e.holdType].label}</span> : <span className="text-gray-300">â€”</span>}</td>
      ...
      {/* â”€â”€ Holds & Exams â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      {activeTab === 'holds' && (
          ...
          {MOCK_ENTRIES.filter(e => e.customsStatus === 'HOLD' || e.customsStatus === 'EXAM').map(e => (
            <div key={e.id} className={`bg-white border rounded-lg p-4 cursor-pointer hover:shadow-md transition-shadow ${e.customsStatus === 'HOLD' ? 'border-red-200 border-l-4 border-l-red-500' : 'border-orange-200 border-l-4 border-l-orange-500'}`} onClick={() => setSelectedEntry(e)}>
              ...
              <div className="flex items-center gap-4 text-xs text-gray-500">
                ...
                <span>{e.pieces} pcs Â· {e.weight}</span>
                <span>Assigned: <strong className="text-gray-700">{e.assignedTo}</strong></span>
              </div>
              <div className="flex gap-1.5 mt-2">{e.documents.filter(d => d.status === 'PENDING').map((d, i) => <span key={i} className="px-2 py-0.5 bg-yellow-100 text-yellow-800 rounded text-xs font-medium">ðŸ“„ {d.type} â€” Pending</span>)}</div>
            </div>
          ))}
        </div>
      )}

      {/* â”€â”€ ISF Filings â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      {activeTab === 'isf' && (
        <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
          ...
          <table className="w-full text-xs"><thead><tr className="bg-gray-50 border-b border-gray-200">
            ...
            {MOCK_ENTRIES.map(e => (
              <tr key={e.id} className={`border-b border-gray-100 hover:bg-gray-50 ${e.isfStatus === 'NOT_FILED' ? 'bg-red-50 border-l-4 border-l-red-400' : e.isfStatus === 'REJECTED' ? 'bg-red-50' : ''}`}>
                ...
                <td className="px-3 py-2.5 text-gray-600">{e.isfBondType || 'â€”'}</td>
      ...
      {/* â”€â”€ CBP Exams â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      {activeTab === 'exams' && (
        <div>
      ...
      {/* â”€â”€ Detail Flyout â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      {selectedEntry && (
          ...
          <div className="relative w-[500px] bg-white shadow-2xl h-full overflow-y-auto border-l border-gray-200" onClick={e => e.stopPropagation()}>
            ...
            <div className="px-5 py-4 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="bg-gray-50 rounded-lg p-2.5"><p className="text-xs text-gray-400">Entry Type</p><p className="text-sm font-semibold">{selectedEntry.entryType || 'â€”'}</p></div>
              ...
              {/* Cargo */}
              <div><h4 className="text-xs font-semibold text-gray-700 mb-2">Cargo & Classification</h4><div className="bg-gray-50 rounded-lg p-3 space-y-1 text-xs"><div className="flex justify-between"><span className="text-gray-500">Commodity</span><span>{selectedEntry.commodity}</span></div><div className="flex justify-between"><span className="text-gray-500">HTS Code</span><span className="font-mono">{selectedEntry.htsCode}</span></div><div className="flex justify-between"><span className="text-gray-500">Pieces / Weight</span><span>{selectedEntry.pieces} pcs Â· {selectedEntry.weight}</span></div><div className="flex justify-between"><span className="text-gray-500">Declared Value</span><span className="font-bold">{fmtCurrency(selectedEntry.declaredValue)}</span></div></div></div>
              {/* ISF */}
              <div><h4 className="text-xs font-semibold text-gray-700 mb-2">ISF Filing</h4><div className="bg-gray-50 rounded-lg p-3 space-y-1 text-xs"><div className="flex justify-between"><span className="text-gray-500">Status</span><span className={`px-1.5 py-0.5 rounded-full font-medium ${ISF_BADGE[selectedEntry.isfStatus]}`}>{selectedEntry.isfStatus.replace('_', ' ')}</span></div><div className="flex justify-between"><span className="text-gray-500">Filed</span><span>{fmtDate(selectedEntry.isfFiledDate)}</span></div><div className="flex justify-between"><span className="text-gray-500">Bond</span><span>{selectedEntry.isfBondType || 'â€”'}</span></div></div></div>
              {/* Timeline */}
      ...
      {showDutyCalc && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50" onClick={() => setShowDutyCalc(false)}>
          <div className="bg-white rounded-xl w-full max-w-2xl max-h-[85vh] overflow-y-auto shadow-2xl" onClick={e => e.stopPropagation()}>
            <div className="px-6 py-4 border-b border-gray-200"><h2 className="text-sm font-semibold text-gray-900">ðŸ’° Duty & Tax Calculator â€” HTS Lookup</h2><p className="text-xs text-gray-400 mt-0.5">Calculate estimated duties, taxes, and fees based on HTS classification</p></div>
      ...
      {showACE && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50" onClick={() => setShowACE(false)}>
          <div className="bg-white rounded-xl w-full max-w-3xl max-h-[85vh] overflow-y-auto shadow-2xl" onClick={e => e.stopPropagation()}>
            <div className="px-6 py-4 border-b border-gray-200"><h2 className="text-sm font-semibold text-gray-900">ðŸ› ACE â€” Automated Commercial Environment</h2><p className="text-xs text-gray-400 mt-0.5">Direct filing integration with CBP ACE portal</p></div>
            <div className="px-6 py-4 space-y-4">
              <div className="bg-green-50 border border-green-200 rounded-lg p-3 flex items-center gap-3"><div className="w-2 h-2 rounded-full bg-green-500" /><div><p className="text-sm font-bold text-green-800">ACE Connected â€” AXON TMS Transport Corp</p><p className="text-xs text-green-600">Filer Code: AGS Â· Bond Type: Continuous Â· Last Sync: 2 min ago</p></div></div>
              ...
              <table className="w-full text-xs"><thead><tr className="bg-gray-50 border-b border-gray-200">
                ...
                {[
                  { entry: 'ENT-2026-04140001', mawb: '176-82445521', type: '01 â€” Consumption', filed: 'Apr 13', duty: 0, status: 'RELEASED', color: 'bg-green-100 text-green-800' },
                  { entry: 'ENT-2026-04140002', mawb: '180-99321100', type: '01 â€” Consumption', filed: 'Apr 13', duty: 2460, status: 'RELEASED', color: 'bg-green-100 text-green-800' },
                  { entry: 'ENT-2026-04130008', mawb: '131-55782100', type: '01 â€” Consumption', filed: 'Apr 13', duty: 855, status: 'FDA HOLD', color: 'bg-red-100 text-red-800' },
                  { entry: 'ENT-2026-04140004', mawb: '235-11887400', type: '01 â€” Consumption', filed: 'Apr 14', duty: 0, status: 'FDA HOLD', color: 'bg-red-100 text-red-800' },
                  { entry: 'ENT-2026-04140005', mawb: '618-77200100', type: '01 â€” Consumption', filed: 'Apr 14', duty: 546, status: 'EPA HOLD', color: 'bg-red-100 text-red-800' },
                  { entry: 'ENT-2026-04140008', mawb: '131-99100300', type: '01 â€” Consumption', filed: 'Apr 14', duty: 1560, status: 'CBP EXAM', color: 'bg-orange-100 text-orange-800' },
                ].map((f, i) => (
                  <tr key={i} className="border-b border-gray-100 hover:bg-gray-50">
                    ...
                    <td className="px-3 py-2 text-right text-gray-700">{f.duty > 0 ? `$${f.duty.toLocaleString()}` : 'â€”'}</td>
