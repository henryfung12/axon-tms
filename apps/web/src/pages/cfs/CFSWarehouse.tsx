...
const MOCK_INVENTORY: WarehouseItem[] = [
  ...
  { id: 'wi9', hawb: 'GE-E-20260414-002', mawb: '176-88100502', orderNumber: 'JFK-EXP-0502', shipper: 'NY Fashion Export LLC', consignee: 'HK Garment Import Co.', consigneeCity: 'Hong Kong', consigneeState: 'HK', commodity: 'Textile / Fashion (Export)', pieces: 32, weight: '4,200 kg', dims: '80x60x80 cm', zone: 'A', location: 'A-EXPORT-05', receivedAt: '2026-04-14T07:00:00Z', storageDays: 0, status: 'CONSOLIDATING', actionNeeded: 'Export consol — 4 shippers â†’ 1 MAWB', temperature: 'Ambient', hazmat: false, highValue: false },
];
