    ...
    <div>
      ...
      {selectedIds.size > 0 && (
        <div className="mt-3 bg-orange-600 text-white rounded-lg p-3 flex items-center justify-between">
          ...
          <div className="flex gap-2">
            <button onClick={() => setShowAssignModal(true)} className="px-4 py-1.5 text-sm font-semibold bg-white text-orange-700 rounded-lg hover:bg-orange-50">ðŸ Assign Driver & Truck</button>
            ...
            <div className="px-6 py-4 space-y-4">
              ...
              <div>
                ...
                <div className="grid grid-cols-3 gap-2">
                  {[
                    { type: 'Sprinter Van', icon: 'ðŸ', desc: 'Up to 3,500 lbs' },
                    { type: '24ft Box Truck', icon: 'ðŸ', desc: 'Up to 10,000 lbs' },
                    { type: '26ft Box Truck', icon: 'ðŸ', desc: 'Up to 12,000 lbs' },
