...
const MOCK_AUDIT: AuditEntry[] = [
  { id: 'au1', timestamp: '2026-04-14T14:22:00Z', user: 'Karen Liu', userRole: 'Operations', module: 'BROKERAGE', category: 'SHIPMENT', action: 'STATUS_CHANGED', entity: 'SH-10421', entityId: 's1', description: 'Shipment status changed to In Transit', details: 'Status: DISPATCHED Ã¢â€ â€™ IN_TRANSIT. Carrier: Eagle Freight Lines. Driver confirmed pickup at Acme Detroit.', ipAddress: '10.0.1.42' },
  ...
  { id: 'au6', timestamp: '2026-04-14T13:15:00Z', user: 'System (EDI)', userRole: 'System', module: 'EDI', category: 'SHIPMENT', action: 'CREATED', entity: 'SH-10428', entityId: 's8', description: 'EDI 204 Load Tender received and auto-accepted', details: 'Partner: Acme Manufacturing (ISA: ACME001). Route: Detroit, MI Ã¢â€ â€™ Columbus, OH. Weight: 45,000 lbs.', ipAddress: 'Ã¢â‚¬â€' },
  { id: 'au7', timestamp: '2026-04-14T12:45:00Z', user: 'Priya Patel', userRole: 'Sales', module: 'BROKERAGE', category: 'RATE', action: 'UPDATED', entity: 'Rate: DETÃ¢â€ â€™CHI', entityId: 'r1', description: 'Contract rate updated', details: 'Customer: Acme Manufacturing. Old rate: $2,600. New rate: $2,800. Effective: 2026-01-01.', ipAddress: '10.0.1.55' },
  { id: 'au8', timestamp: '2026-04-14T12:30:00Z', user: 'Marcus Johnson', userRole: 'Driver', module: 'DRIVER_APP', category: 'LOAD', action: 'STATUS_CHANGED', entity: 'LD-4521', entityId: 'L001', description: 'Driver updated load status: At Delivery', details: 'Status: IN_TRANSIT Ã¢â€ â€™ AT_DELIVERY. Location: Nashville, TN. Via Driver Mobile App.', ipAddress: '72.84.102.55' },
  ...
  { id: 'au16', timestamp: '2026-04-14T09:15:00Z', user: 'Karen Liu', userRole: 'Operations', module: 'BROKERAGE', category: 'SHIPMENT', action: 'CREATED', entity: 'SH-10432', entityId: 's12', description: 'New shipment created', details: 'Customer: Heartland Foods. Route: Omaha, NE Ã¢â€ â€™ Denver, CO. Rate: $3,100. Equipment: Reefer.', ipAddress: '10.0.1.42' },
  { id: 'au17', timestamp: '2026-04-14T09:00:00Z', user: 'Mike Santos', userRole: 'Manager', module: 'BROKERAGE', category: 'CUSTOMER', action: 'UPDATED', entity: 'Customer: Acme Manufacturing', entityId: 'c1', description: 'Customer credit limit updated', details: 'Credit limit: $75,000 Ã¢â€ â€™ $100,000. Approved by Mike Santos.', ipAddress: '10.0.1.38' },
...
const ACTION_BADGE: Record<string, { bg: string; icon: string }> = {
  ...
  UPDATED: { bg: 'bg-blue-100 text-blue-800', icon: 'Ã¢Å“Å½' },
  DELETED: { bg: 'bg-red-100 text-red-800', icon: 'Ã¢Å“â€¢' },
  STATUS_CHANGED: { bg: 'bg-yellow-100 text-yellow-800', icon: 'Ã¢Å¸Â³' },
  ASSIGNED: { bg: 'bg-purple-100 text-purple-800', icon: 'Ã¢â€ â€™' },
  UPLOADED: { bg: 'bg-teal-100 text-teal-800', icon: 'Ã¢â€ â€˜' },
  SYNCED: { bg: 'bg-indigo-100 text-indigo-800', icon: 'Ã¢â€¡â€ž' },
  SENT: { bg: 'bg-cyan-100 text-cyan-800', icon: 'Ã¢â€ â€”' },
  APPROVED: { bg: 'bg-green-100 text-green-800', icon: 'Ã¢Å“â€œ' },
  REJECTED: { bg: 'bg-red-100 text-red-800', icon: 'Ã¢Å“â€¢' },
  LOGIN: { bg: 'bg-gray-100 text-gray-700', icon: 'Ã°Å¸â€â€˜' },
  EXPORTED: { bg: 'bg-orange-100 text-orange-800', icon: 'Ã¢Â¬â€¡' },
};

const CATEGORY_ICON: Record<string, string> = {
  LOAD: 'Ã°Å¸â€œÂ¦', SHIPMENT: 'Ã°Å¸Å¡Å¡', INVOICE: 'Ã°Å¸Â§Â¾', CARRIER: 'Ã°Å¸ÂÂ¢', CUSTOMER: 'Ã°Å¸â€˜Â¥', DRIVER: 'Ã°Å¸â€˜Â¤',
  ASSET: 'Ã°Å¸Å¡â€º', SETTINGS: 'Ã¢Å¡â„¢', USER: 'Ã°Å¸â€Â', DOCUMENT: 'Ã°Å¸â€œâ€ž', CLAIM: 'Ã¢Å¡Â ', RATE: 'Ã°Å¸â€™Â°',
  PAYMENT: 'Ã°Å¸â€™Â³', TRACKING: 'Ã°Å¸â€œÂ¡', AUTH: 'Ã°Å¸â€â€˜',
};
    ...
    <div>
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex gap-2">
          <button onClick={exportAudit} className="px-4 py-1.5 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50">Ã¢Â¬â€¡ Export</button>
        </div>
      </div>
            ...
            {filtered.map(e => {
              ...
              return (
                <tr key={e.id} className="border-b border-gray-100 hover:bg-gray-50 cursor-pointer" onClick={() => setSelectedEntry(e)}>
                  ...
                  <td className="px-3 py-2 text-center" title={e.category}>{CATEGORY_ICON[e.category] || 'Ã°Å¸â€œÅ’'}</td>
          ...
          <div className="relative w-[460px] bg-white shadow-2xl h-full overflow-y-auto border-l border-gray-200" onClick={e => e.stopPropagation()}>
            <div className="px-5 py-4 border-b border-gray-200">
              <div className="flex items-center justify-between mb-2">
                ...
                <button onClick={() => setSelectedEntry(null)} className="text-gray-400 hover:text-gray-600 text-lg">Ãƒâ€”</button>
              </div>
            ...
            <div className="px-5 py-4 space-y-4">
              ...
              <div className="bg-gray-50 rounded-lg p-3">
                ...
                <p className="text-xs text-gray-500">{selectedEntry.userRole} Ã‚Â· IP: {selectedEntry.ipAddress}</p>
              </div>
