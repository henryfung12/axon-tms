...
export function AssetsPage() {
  ...
  return (
    <div>
      ...
      {/* â”€â”€ Document Upload / Dropbox Zones â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
          ...
          {activeTab === 'TRUCK' ? (
            <div className="bg-white border border-gray-200 rounded-lg p-3">
              ...
              <div className="flex gap-2 mt-1.5 text-xs">
                ...
                {stats.lowFuel > 0 && <><span className="text-gray-300">Â·</span><span className="text-yellow-600">{stats.lowFuel} low fuel</span></>}
              </div>
            </div>
          ) : (
            <div className="bg-white border border-gray-200 rounded-lg p-3">
      ...
      {/* â”€â”€ Status Filters â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
                    ...
                    {asset.type === 'TRUCK' && (
                      <>
                        ...
                        <td className="px-3 py-2.5">
                          ...
                          ) : asset.eldConnected ? <span className="text-green-600 text-xs">Clear</span> : <span className="text-gray-300">â€”</span>}
                        </td>
                      </>
                    )}
      ...
      {/* â”€â”€ Asset Detail Flyout â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      {selectedAsset && (
          ...
          <div className="relative w-[420px] bg-white shadow-2xl h-full overflow-y-auto border-l border-gray-200" onClick={e => e.stopPropagation()}>
            ...
            <div className="px-5 py-4 border-b border-gray-200 flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-gray-400 mt-0.5">{selectedAsset.make} {selectedAsset.model} Â· {selectedAsset.year}</p>
              </div>
              <div className="flex items-center gap-2">
                  ...
                  <div className="bg-gray-50 rounded-lg p-3 space-y-2">
                    <div className="grid grid-cols-3 gap-3">
                      <div className="text-center">
                        <p className={`text-lg font-bold ${selectedAsset.engineStatus ? ENGINE_COLORS[selectedAsset.engineStatus] : 'text-gray-300'}`}>
                          {selectedAsset.engineStatus ? ENGINE_LABELS[selectedAsset.engineStatus] : 'â€”'}
                        </p>
                      ...
                      <div className="text-center">
                        <p className={`text-lg font-bold ${selectedAsset.fuelLevelPct !== null && selectedAsset.fuelLevelPct < 25 ? 'text-red-600' : selectedAsset.fuelLevelPct !== null && selectedAsset.fuelLevelPct < 50 ? 'text-yellow-600' : 'text-gray-900'}`}>
                          {selectedAsset.fuelLevelPct !== null ? `${selectedAsset.fuelLevelPct}%` : 'â€”'}
                        </p>
                    ...
                    <div className="grid grid-cols-2 gap-3 pt-2 border-t border-gray-200">
                      ...
                      <div>
                        ...
                        <span className="text-xs text-gray-800">{selectedAsset.eldLastPing ? new Date(selectedAsset.eldLastPing).toLocaleTimeString('en-US', { hour: 'numeric', minute: '2-digit' }) : 'â€”'}</span>
                      </div>
                    </div>
                ...
                <div>
                  ...
                  <div className="space-y-1.5">{(selectedAsset.insuranceCards || []).map(c => (
                    <div key={c.id} className="flex items-center justify-between py-2 px-3 bg-gray-50 rounded-lg">
                      <div><p className="text-xs font-medium text-gray-800">{c.state} â€” {c.carrier}</p><p className="text-xs text-gray-400">Policy: {c.policyNumber} Â· {c.effectiveDate} â†’ {c.expirationDate}</p></div>
      ...
      {/* â”€â”€ Add Asset Modal â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      {showAddModal && (
          ...
          <div className="bg-white rounded-xl w-full max-w-2xl shadow-2xl" onClick={e => e.stopPropagation()}>
            ...
            <div className="px-6 py-4 space-y-4">
              ...
              <div className="bg-green-50 border border-green-200 rounded-lg p-4 space-y-3">
                ...
                <p className="text-xs text-green-600">Upload the state insurance ID card â€” VIN will be auto-verified</p>
                <div className="border-2 border-dashed border-green-300 rounded-lg p-4 text-center cursor-pointer hover:border-green-500 hover:bg-green-100">
                  ...
                  <p className="text-xs text-gray-400">PDF, JPG, PNG â€” will auto-scan VIN and link to this asset</p>
                </div>
              </div>
              ...
              <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 space-y-3">
                ...
                <p className="text-xs text-amber-600">Upload the state vehicle registration â€” VIN will be auto-verified and matched</p>
      ...
      {/* â”€â”€ PM Schedule Modal â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      {showPMSchedule && (
      ...
      {/* â”€â”€ Company COI Modal â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      {showCOI && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50" onClick={() => setShowCOI(false)}>
          <div className="bg-white rounded-xl w-full max-w-3xl max-h-[85vh] overflow-y-auto shadow-2xl" onClick={e => e.stopPropagation()}>
            <div className="px-6 py-4 border-b border-gray-200"><h2 className="text-sm font-semibold text-gray-900">Company Certificate of Insurance (COI)</h2><p className="text-xs text-gray-400 mt-0.5">ACORD 25 â€” Certificate of Liability Insurance</p></div>
            <div className="px-6 py-4 space-y-4">
              <div className="bg-green-50 border border-green-200 rounded-lg p-3 flex items-center gap-3"><span className="text-xl">âœ…</span><div><p className="text-sm font-bold text-green-800">COI Active â€” All Policies Current</p><p className="text-xs text-green-600">ACORD Certificate #CL2631361416 Â· Issued 03/13/2026</p></div></div>

              <div className="bg-gray-50 rounded-lg p-4">
                <div className="grid grid-cols-2 gap-3 mb-3"><div><p className="text-xs text-gray-400">Insured</p><p className="text-sm font-bold">AXON TMS Transport Corporation</p><p className="text-xs text-gray-500">184-54 149th Avenue, 1st Floor</p><p className="text-xs text-gray-500">Springfield Gardens, NY 11413</p></div><div><p className="text-xs text-gray-400">Producer</p><p className="text-sm font-semibold">AssuredPartners Northeast, LLC</p><p className="text-xs text-gray-500">800 Westchester Ave, Suite S-714, Rye Brook NY 10573</p><p className="text-xs text-gray-500">Contact: Shaunna Marquis Â· (914) 761-9000</p></div></div>
              </div>
      ...
      {/* â”€â”€ Insurance Cards Modal â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      {showInsCards && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50" onClick={() => setShowInsCards(false)}>
          <div className="bg-white rounded-xl w-full max-w-3xl max-h-[85vh] overflow-y-auto shadow-2xl" onClick={e => e.stopPropagation()}>
            <div className="px-6 py-4 border-b border-gray-200"><h2 className="text-sm font-semibold text-gray-900">Vehicle Insurance Cards</h2><p className="text-xs text-gray-400 mt-0.5">Upload insurance ID cards â€” VIN# will be auto-scanned and matched to fleet assets</p></div>
            <div className="px-6 py-4 space-y-4">
              {/* Upload zone */}
              <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center cursor-pointer hover:border-blue-400 hover:bg-blue-50" onClick={() => { setInsCardParsing(true); setTimeout(() => { setParsedInsCards([
                ...
                {insCardParsing ? (
                  ...
                  <div><p className="text-2xl mb-2">ðŸªª</p><p className="text-sm font-semibold text-gray-700">Upload Insurance Cards</p><p className="text-xs text-gray-400 mt-1">Drop PDF, JPG, or PNG â€” supports batch upload of multiple cards</p><p className="text-xs text-gray-400">VIN# on each card will be auto-matched to your fleet assets</p></div>
                )}
              </div>
              ...
              {parsedInsCards.length > 0 && (
                <div>
                  <div className="bg-green-50 border border-green-200 rounded-lg p-3 mb-3 flex items-center gap-2"><span className="text-lg">âœ…</span><span className="text-sm font-bold text-green-800">{parsedInsCards.length} cards scanned â€” all VINs matched to fleet</span></div>
      ...
      {/* â”€â”€ Registration Cards Modal â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      {showRegCards && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50" onClick={() => setShowRegCards(false)}>
          <div className="bg-white rounded-xl w-full max-w-3xl max-h-[85vh] overflow-y-auto shadow-2xl" onClick={e => e.stopPropagation()}>
            <div className="px-6 py-4 border-b border-gray-200"><h2 className="text-sm font-semibold text-gray-900">Vehicle Registration Cards</h2><p className="text-xs text-gray-400 mt-0.5">Upload registration documents â€” VIN# will be auto-scanned and matched to fleet assets</p></div>
            <div className="px-6 py-4 space-y-4">
              {/* Upload zone */}
              <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center cursor-pointer hover:border-blue-400 hover:bg-blue-50" onClick={() => { setRegCardParsing(true); setTimeout(() => { setParsedRegCards([
                ...
                {regCardParsing ? (
                  ...
                  <div><p className="text-2xl mb-2">ðŸ“„</p><p className="text-sm font-semibold text-gray-700">Upload Registration Cards</p><p className="text-xs text-gray-400 mt-1">Drop PDF, JPG, or PNG â€” supports batch upload</p><p className="text-xs text-gray-400">VIN# on each card will be auto-matched to your fleet assets</p></div>
                )}
              </div>
              ...
              {parsedRegCards.length > 0 && (
                <div>
                  <div className="bg-green-50 border border-green-200 rounded-lg p-3 mb-3 flex items-center gap-2"><span className="text-lg">âœ…</span><span className="text-sm font-bold text-green-800">{parsedRegCards.length} registration(s) scanned â€” VIN matched to fleet</span></div>
                  {parsedRegCards.map((c, i) => (
                    <div key={i} className="bg-green-50 border border-green-200 rounded-lg p-4 space-y-3">
                      <div className="flex items-center justify-between"><span className="text-sm font-bold text-gray-900">NY State Registration Document</span><span className="px-2 py-0.5 bg-green-200 text-green-800 rounded text-xs font-bold">{c.matchedUnit} â€” {c.matchConfidence}</span></div>
                ...
                <div className="space-y-1.5">
                  {MOCK_TRUCKS.filter(t => (t.registrationCards || []).length > 0).map(t => t.registrationCards.map(c => (
                    <div key={c.id} className={`flex items-center justify-between py-2 px-3 rounded-lg ${new Date(c.expiry) < new Date('2026-04-14') ? 'bg-red-50 border border-red-200' : 'bg-gray-50'}`}>
                      <div className="flex items-center gap-3">
                        <span className="px-2 py-0.5 bg-blue-100 text-blue-800 rounded text-xs font-bold">{t.unitNumber}</span>
                        <div><p className="text-xs font-medium text-gray-800">{c.state} â€” Plate: {c.plateNumber}</p><p className="text-xs text-gray-400">VIN: {c.vin} Â· {c.year} {c.make} Â· Exp: {new Date(c.expiry).toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' })}</p></div>
                      </div>
                      <div className="flex items-center gap-2">
                        ...
                        <button onClick={() => { setSendDocType(`Registration (${c.state} â€” ${t.unitNumber})`); setShowSendToDriver(true); }} className="text-xs text-violet-600">ðŸ“± Send</button>
                      </div>
                    </div>
                  )))}
                </div>
      ...
      {/* â”€â”€ Send to Driver Modal â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      {showSendToDriver && (
