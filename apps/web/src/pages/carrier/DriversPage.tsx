...
const MOCK_DRIVERS = [
  { id: 'd1', user: { firstName: 'Marcus', lastName: 'Johnson', email: 'marcus.j@geminiexpress.com', phone: '(555) 901-2345' }, cdlClass: 'A', cdlExpiry: '2028-06-15', hosHoursUsed: 4.5, status: 'DRIVING' },
  { id: 'd2', user: { firstName: 'Sarah', lastName: 'Chen', email: 'sarah.c@geminiexpress.com', phone: '(555) 234-5678' }, cdlClass: 'A', cdlExpiry: '2029-03-20', hosHoursUsed: 0, status: 'AVAILABLE' },
  { id: 'd3', user: { firstName: 'James', lastName: 'Williams', email: 'james.w@geminiexpress.com', phone: '(555) 567-8901' }, cdlClass: 'A', cdlExpiry: '2027-11-30', hosHoursUsed: 7.8, status: 'DRIVING' },
  { id: 'd4', user: { firstName: 'Maria', lastName: 'Rodriguez', email: 'maria.r@geminiexpress.com', phone: '(555) 678-9012' }, cdlClass: 'A', cdlExpiry: '2030-01-10', hosHoursUsed: 0, status: 'AVAILABLE' },
  { id: 'd5', user: { firstName: 'David', lastName: 'Kim', email: 'david.k@geminiexpress.com', phone: '(555) 789-0123' }, cdlClass: 'A', cdlExpiry: '2028-09-22', hosHoursUsed: 0, status: 'OFF_DUTY' },
  { id: 'd6', user: { firstName: 'Emily', lastName: 'Taylor', email: 'emily.t@geminiexpress.com', phone: '(555) 345-6789' }, cdlClass: 'A', cdlExpiry: '2029-07-14', hosHoursUsed: 0, status: 'SLEEPER_BERTH' },
  { id: 'd7', user: { firstName: 'Robert', lastName: 'Brown', email: 'robert.b@geminiexpress.com', phone: '(555) 456-7890' }, cdlClass: 'A', cdlExpiry: '2028-04-18', hosHoursUsed: 3.0, status: 'DRIVING' },
  { id: 'd8', user: { firstName: 'Lisa', lastName: 'Nguyen', email: 'lisa.n@geminiexpress.com', phone: '(555) 012-3456' }, cdlClass: 'A', cdlExpiry: '2029-11-05', hosHoursUsed: 0, status: 'AVAILABLE' },
];
