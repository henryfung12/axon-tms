...
export function FleetIntelligencePage() {
  ...
  const exportIFTA = () => {
    ...
    XLSX.writeFile(wb, `Gemini_Express_IFTA_${new Date().toISOString().split('T')[0]}.xlsx`);
  };
  ...
  const exportHUT = () => {
    ...
    XLSX.writeFile(wb, `Gemini_Express_HUT_${new Date().toISOString().split('T')[0]}.xlsx`);
  };
        ...
        <>
          <div className="flex items-center justify-between mb-3">
            ...
            <button onClick={() => {
              ...
              XLSX.writeFile(wb, `Gemini_Express_Tolls_${new Date().toISOString().split('T')[0]}.xlsx`);
