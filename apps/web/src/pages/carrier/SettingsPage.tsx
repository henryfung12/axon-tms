...
const MOCK_INTEGRATIONS: Integration[] = [
  { id: 'int1', name: 'CargoWise One', provider: 'WiseTech Global', type: 'Accounting / TMS', status: 'CONNECTED', lastSync: '2026-04-13T12:30:00Z', icon: 'ðŸ', description: 'Push loads, sync invoices, and manage AR/AP through CargoWise.' },
  ...
  { id: 'int5c', name: 'OTR Solutions', provider: 'OTR Solutions Inc.', type: 'Factoring / Quick-Pay', status: 'CONNECTED', lastSync: '2026-04-13T14:00:00Z', icon: 'ðŸ', description: 'Carrier factoring, fuel card programs, and quick-pay services.' },
  ...
  { id: 'int7', name: 'Truckstop.com', provider: 'Truckstop', type: 'Load Board', status: 'CONNECTED', lastSync: '2026-04-13T10:30:00Z', icon: 'ðŸ', description: 'Load posting, rate analytics, carrier onboarding.' },
                      ...
                      <td className="px-3 py-2.5">
                        <div className="flex gap-1">
                          {(u.role === 'FULL_ADMIN' || u.role === 'ADMIN') ? (
                            ...
                            <>
                              {['OPERATIONS', 'MANAGER'].includes(u.role) && <span className="px-1.5 py-0.5 rounded text-xs font-medium bg-blue-100 text-blue-800">ðŸ</span>}
                    ...
                    <div className="px-5 py-4">
                      <div className="flex items-center justify-between mb-1">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          {k.status === 'ACTIVE' && <>
                            <button className="p-1.5 text-gray-400 hover:text-blue-600 rounded hover:bg-blue-50" title="Edit"><span className="text-xs">â</span></button>
            ...
            <div className="px-6 py-4 space-y-4">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                ...
                <div className="grid grid-cols-4 gap-2">
                  {[
                    { id: 'carrier', label: 'Carrier', icon: 'ðŸ', color: 'border-blue-300 bg-blue-100 text-blue-800' },
